        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                <td><img src="{{ asset('images/subcategory') . '/'.$subcategory->image }}" class="img-responsive img-thumbnail" style="max-width: 100px;"></td>
                <td>{{$subcategory->name}}</td>
                <td>
                  <a href="javascript::void(0)" id="edit" data-id="{{ $subcategory->id }}" data-name="{{ $subcategory->name }}" data-image="{{ asset('images/subcategory') . '/'.$subcategory->image }}" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal" data-formUrl="{{route('subCategoryUpdate',$subcategory->id)}}">EDIT</a>
                  
                  <a href="javascript::void(0)" id="delete" data-id="{{ $subcategory->id }}" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModal" data-formUrl="{{route('subCategoryDelete',$subcategory->id)}}">DELETE</a>
                </td>
              </tr>
              @endforeach
            </tbody>
